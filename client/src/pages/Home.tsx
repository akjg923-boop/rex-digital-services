...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Featured Voice Artists Section */}
      <section className="py-20 bg-card/30">
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">أبرز المعلقين الصوتيين</h2>
            <div className="w-24 h-1 bg-primary mx-auto mb-6"></div>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              استمع إلى عينات من أعمال أفضل المعلقين الصوتيين لدينا
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-12">
            ...
            <Card className="border-2 border-border bg-card hover:border-primary/50 transition-all">
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-xl font-bold">أحمد عبدالرحيم</h3>
                ...
                <p className="text-sm text-muted-foreground mb-4">معلق صوتي محترف في الإعلانات والوثائقيات</p>
                <div className="mb-4 bg-card-foreground/5 rounded-lg p-3">
                  <audio 
                    controls 
            ...
            <Card className="border-2 border-border bg-card hover:border-primary/50 transition-all">
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-xl font-bold">أسماء بكر</h3>
                  <div className="flex items-center gap-1">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-4 h-4 fill-yellow-500 text-yellow-500" />
                    ))}
                ...
                <p className="text-sm text-muted-foreground mb-4">معلقة صوتية متخصصة في الدوبلاج والمحتوى التعليمي</p>
                <div className="mb-4 bg-card-foreground/5 rounded-lg p-3">
                  <audio 
                    controls 
                    className="w-full h-8"
            ...
            <Card className="border-2 border-border bg-card hover:border-primary/50 transition-all">
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-xl font-bold">إبراهيم محمد</h3>
                  <div className="flex items-center gap-1">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-4 h-4 fill-yellow-500 text-yellow-500" />
                    ))}
                ...
                <p className="text-sm text-muted-foreground mb-4">صوت مميز للإعلانات التجارية والبرامج الإذاعية</p>
                <div className="mb-4 bg-card-foreground/5 rounded-lg p-3">
                  <audio 
                    controls 
                    className="w-full h-8"
